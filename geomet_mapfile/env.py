...
DEBUG = str2bool(os.environ.get('GEOMET_MAPFILE_DEBUG', False))
OWS_LOG_PATH = os.environ.get('GEOMET_MAPFILE_OWS_LOG', None)
...
CELERY_BROKER_URL = os.environ.get('GEOMET_CELERY_BROKER_URL', None)
...
LOGGER.debug(CELERY_BROKER_URL)
